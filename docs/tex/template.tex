...
\runninghead{GEVIS - Gene Expression VIS} % A shortened article title to appear in the running head, leave this command empty for no running head
...
\title{GEVIS - Gene Expression VIS} % Article title, use manual lines breaks (\\) to beautify the layout
